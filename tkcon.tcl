...
#	[expr {$OPT(maxlinelen)?$OPT(maxlinelen):{unlimited}}]"
 	...
 	puts "TkCon v$PRIV(version) designed by Jeffrey Hobbs (Tcl$::tcl_patchLevel / Tk$::tk_patchLevel)."
	Prompt ""
}
...
proc ::tkcon::InitSlave {slave {slaveargs {}} {slaveargv0 {}}} {
    ...
    interp alias $slave ez {} $::dApp::Obj(nbo) ezopen
    interp alias $slave ezdo {} $::dApp::Obj(nbo) ezdo
...
proc ::tkcon::InitUI {title} {
    ...
    set root $PRIV(root)
    if {$root eq "."} { set w {} } else { set w  [::ttk::frame $root -borderwidth 0 -relief groove]}
...
proc ::tkcon::About {} {
	...
	text $w.text -height 9 -width 60 \
		...
		-background $COLOR(bg) \
		-font $OPT(font) -borderwidth 0 -highlightthickness 0
...
proc tkcon {cmd args} {
	...
	get - gets {
		...
		text $t.data -width 32 -height 5 -wrap none \
			...
			-yscrollcommand [list $t.sy set] -borderwidth 0
...
proc edit {args} {
	...
	-font $::tkcon::OPT(font) -borderwidth 0 -highlightthickness 0
    catch {
	# 8.4+ stuff
