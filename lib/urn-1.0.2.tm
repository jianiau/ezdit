...
# Meta category        Tcl Uniform Resource Identifier Management
# Meta description     URI utilities, URN scheme
# Meta license         BSD
# Meta platform        tcl
# Meta require         {uri 1.1.2}
# Meta subject         uri urn {rfc 2141} url
# Meta summary         uri_urn
# @@ Meta End
